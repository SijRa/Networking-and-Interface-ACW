...
namespace locationserver
{
    public class Response
    {
        ...
        protected void SendWHOIS(string name, string newLocation)
        {
            ...
            {
                string updatedLocation = Program.UpdateLocation(name, newLocation);//UPDATE LOCATION
            ...
            {
                string retrievedLocation = Program.RetrieveLocation(name);//GET Location
        ...
        protected void SendHTTP(string name, string newLocation)
        {
            ...
            switch (ProtocolVersion)
            {
                case "0.9":
                    ...
                    {
                        string retrievedLocation = Program.RetrieveLocation(name);
                    ...
                    {
                        string updatedLocation = Program.UpdateLocation(name,newLocation);
